...
export class Lightbox extends LitElement {
  ...
  async _openLightbox() {
    ...
    this.dispatchEvent(
      new CustomEvent('LightboxOpened', { bubbles: true, composed: false })
    );
  }
  ...
  async _closeLightbox() {
    ...
    this.dispatchEvent(
      new CustomEvent('LightboxClosed', { bubbles: true, composed: false })
    );
  }
  ...
  render() {
    return html`
       ...
       <div class="lightbox__shadow ${this._openClass}" @click=${
      this._closeLightbox
    }>
         <img
           class="lightbox__created-image animate__animated ${
             this._open ? 'animate__fadeIn' : 'animate__fadeOut'
           }"
